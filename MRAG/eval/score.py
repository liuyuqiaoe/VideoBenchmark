...
from MRAG.eval.utils.gpt_extract import extract_answer 
from MRAG.eval.utils.automatic_extract import parse_multi_choice_response
...
if __name__ == "__main__":
    ...
    outputroot = os.path.join(os.getcwd(), "colbert/tests/results")
    if not os.path.exists(outputroot):
        os.makedirs(outputroot)
    outputpath = os.path.join(outputroot, outputpath)
    outfile = {}
    ...
    extra_output_path = outputpath.split('.')[0] + '_extra_extraction_needed.json'
